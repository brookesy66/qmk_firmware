...
// Custom tap dance for RGUI / layer toggle
...
void td_g_reset(tap_dance_state_t *state, void *user_data) {
    if (state->count == 1) {
...
tap_dance_action_t tap_dance_actions[] = {
    ...
    [TD_G] = ACTION_TAP_DANCE_FN_ADVANCED(NULL, td_g_finished, td_g_reset),
};
